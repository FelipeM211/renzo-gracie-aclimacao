      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-5">
            <h3 className="text-2xl font-bold text-white">Renzo Gracie <span className="text-royal-blue">Aclimação</span></h3>
            <p className="text-sm text-neutral-400">Legítima Jiu-Jitsu Brasileiro. Disciplina e respeito.</p>
            <div className="flex gap-4">
              <a href="#" className="p-2 rounded-lg bg-neutral-900 text-white transition-colors hover:bg-royal-blue/90">
                <FaInstagram size={20} />
              </a>
              <a href="#" className="p-2 rounded-lg bg-neutral-900 text-white transition-colors hover:bg-royal-blue/90">
                <FaFacebookF size={20} />
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex gap-3"><MapPin size={18} className="text-royal-blue" /> Rua Amarante, 21 - Cambuci, São Paulo</li>
              <li className="flex gap-3"><Phone size={18} className="text-royal-blue" /> (11) 3209-4445</li>
            </ul>
          </div>
        </div>
